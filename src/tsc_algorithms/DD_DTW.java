 ...
 * 
 *         Implementation of: G贸recki, Tomasz, and Maciej 艁uczak. Using
...
public class DD_DTW extends kNN {
	...
	public static final String DATA_DIR = "G:/数据/University of East Anglia Norwich/TSC Problems/";
	...
	public static void recreateResultsTable(int seed) throws Exception {
		...
		String dataDir = "G:/数据/University of East Anglia Norwich/TSC Problems/";
